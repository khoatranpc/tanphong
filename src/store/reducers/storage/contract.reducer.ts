...
export const queryDeleteontractStorage = createRequest(DELETE_CONTRACT_STORAGE, '/hopdong/$params', 'DELETE');
const contractStorage = createSliceReducer('contractStorage', undefined, [queryGetContractStorage, queryPostContractStorage, queryPutContractStorage, queryDeleteontractStorage]);
