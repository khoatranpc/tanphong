...
import { CREATE_PAYMENT_CONTRACT, GET_PAYMENT_CONTRACT, UPDATE_PAYMENT_CONTRACT } from "@/store/type.actions";
...
const paymentContract = createSliceReducer('paymentContract', undefined, [queryCreatePaymentContract, queryGetPaymentContract, queryUpdatePaymentContract]);
