import { PROPERTY_STORAGE, POST_PROPERTY_STORAGE, PUT_PROPERTY_STORAGE } from "@/store/type.actions";
...
const propertyStorage = createSliceReducer('propertyStorage', undefined, [queryGetPropertyStorage, queryPostPropertyStorage, queryPutPropertyStorage]);
